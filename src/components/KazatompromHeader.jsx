...
import KazatompromLanguageSelector from "./KazatompromLanguageSelector";
import { useLanguage } from "@/contexts/LanguageContext";

const SCROLL_THRESHOLD = 10;
const DESKTOP_WIDTH = 1130;

const KazatompromHeader = ({ onOpenModal }) => {
            ...
            >
              <nav className="mx-auto flex max-w-sm flex-col space-y-6 text-lg">
                ...
                <div className="pt-4 flex flex-col gap-4">
                  <KazatompromLanguageSelector align="left" />
                  <GlowButton
                    onClick={() => {
                      onOpenModal?.();
                      setIsMobileMenuOpen(false);
          ...
          >
            ...
            <div className="flex items-center gap-3">
              ...
              >
                ...
                >
                  <KazatompromLanguageSelector align={isDesktop ? "right" : "left"} />
                </div>
                {isDesktop && (
...
export default KazatompromHeader;
